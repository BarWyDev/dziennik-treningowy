      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-56 rounded-md shadow-lg bg-white dark:bg-[#161b22] ring-1 ring-black ring-opacity-5 dark:ring-gray-800 divide-y divide-gray-100 dark:divide-gray-800 z-50">
          ...
          <div className="py-1">
            <a
              href="/settings"
              className="w-full text-left px-4 py-2 text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-gray-100 flex items-center gap-2 transition-colors"
              style={{ fontSize: '14px' }}
            >
